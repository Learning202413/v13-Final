/* js/views/postprensa.sidebar.js */

const NAV_LINKS = [
    { id: 'cola', name: 'Mis Tareas (Cola)', icon: 'list-todo', href: 'cola' },
    { id: 'cola-general', name: 'Cola General (Pull)', icon: 'list-plus', href: 'cola-general' }
];
