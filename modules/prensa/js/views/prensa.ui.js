/**
 * js/views/prensa.ui.js
 * Lógica global de la interfaz de usuario (modales, sidebar toggle, etc.) para Prensa.
 */
...
const UI = (function() {
    ...
    // --- Funciones helper para los modales de 'operador' ---
    // Estas funciones son llamadas por 'onclick' en operador.html
    function showIncidentModal() {
        showModal('incident-modal-container', 'incident-modal-content');
    }
    function hideIncidentModal() {
        hideModal('incident-modal-container');
    }
    function showFinishModal() {
        showModal('finish-modal-container', 'finish-modal-content');
    }
     function hideFinishModal() {
        hideModal('finish-modal-container');
    }
    ...
    function initGlobalEvents() {
        ...
        if (toggleButton) {
            ...
            // Exponer funciones helper de modales
            window.showIncidentModal = showIncidentModal;
            window.hideIncidentModal = hideIncidentModal;
            window.showFinishModal = showFinishModal;
            window.hideFinishModal = hideFinishModal;
