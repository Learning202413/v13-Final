/* js/views/admin.sidebar.js */

const NAV_LINKS = [
    { id: 'dashboard', name: 'Dashboard Gerencial', icon: 'layout-dashboard', href: 'dashboard' },
    { id: 'produccion', name: 'Control de Producción', icon: 'kanban', href: 'produccion' },
    { id: 'historial-global', name: 'Log de Auditoría Global', icon: 'history', href: 'historial-global' },
    { id: 'historial-orden', name: 'Trazabilidad de OT', icon: 'file-search', href: 'historial-orden' },
    { id: 'usuarios', name: 'Gestión de Usuarios', icon: 'users', href: 'usuarios' },
    { id: 'proveedores', name: 'Gestión de Proveedores', icon: 'briefcase', href: 'proveedores' }
];
...
export function renderSidebar(currentPageId, userName = 'Usuario') {
    ...
    NAV_LINKS.forEach(link => {
        const isActive = currentPageId === link.id; // Nota: Corregido para comparar con link.id o link.href según consistencia
        linksHtml += `
    ...
    if (logoutBtn) {
        logoutBtn.addEventListener('click', () => {
            ...
            // 2. Redirigir al Login (Subir 2 niveles desde /modules/admin/index.html)
